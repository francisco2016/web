...
<body>
    ...
    <main> 
        ...
        <h2> <b>INFORMACIÓN SOBRE COOKIES</b> </h2>
        <h4> 
            Conforme con la Ley 34/2002, de 11 de julio, de servicios de la sociedad de 
            la información y de comercio electrónico &#x3014;LSSI&#x3015;, en relación con el Reglamento 
            &#x3014;UE&#x3015; 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, 
            General de Protección de Datos &#x3014;GDPR&#x3015; y la Ley Orgánica 3/2018, de 5 de 
            diciembre, de Protección de Datos y Garantía de los Derechos Digitales 
            &#x3014;LOPDGDD&#x3015;, es obligado obtener el consentimiento expreso del usuario de todas 
            las páginas web que usan cookies prescindibles, antes de que este navegue por 
            ellas. 
        </h4>
        ...
        <h4>
            ...
            para almacenar y recuperar información acerca de sus visitantes, así como para 
            ofrecer un correcto funcionamiento del sitio. <br>
        ...
        <h4>
            ...
            informado por parte del usuario son las cookies de analítica y las de 
            publicidad y afiliación, quedando exceptuadas las de carácter técnico y las 
        ...
        <h5> SEGÚN LA FINALIDAD </h5>
            ...
            <ul>
                ...
                <li>
                    ...
                    plataformas, con el fin de introducir mejoras en función del análisis de 
                ...
                <li>
                    Cookies de publicidad comportamental: recogen información sobre las preferencias y 
                    elecciones personales del usuario (retargeting) para permitir la gestión, de la 
                ...
                <li>
                    Cookies sociales: son establecidas por las plataformas de redes sociales 
                    ...
                    en línea fuera de los Servicios. Esto puede afectar al contenido y los mensajes 
                    que ve en otros servicios que visita.
                </li>
                <li>
        ...
        <ul>
            <li>
                Cookies propias: son aquellas que se envían al equipo terminal del usuario 
                desde un equipo o dominio gestionado por el propio editor y desde el que 
        ...
        <ul>
            ...
            <li>
                ...
                período definido por el responsable de la cookie, y que puede ir de unos 
        ...
        <h4>
            TUROMAS S.L es el Responsable del tratamiento de los datos personales del 
            Interesado y le informa de que estos datos serán tratados de conformidad con 
            lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril de 2016 (GDPR), 
            por lo que se le facilita la siguiente información del tratamiento:
        </h4>
        <h4>
            Fines del tratamiento: según se especifica en el apartado de cookies que se 
            utilizan en este sitio web.
        </h4>
        <h4>
        Legitimación del tratamiento: salvo en los casos en los que resulte necesario 
        para la navegación por la web, por consentimiento del interesado &#x3014;art. 6.1 GDPR&#x3015;.    
        </h4>
        <h4>
            Criterios de conservación de los datos: según se especifica en el apartado de 
            cookies utilizadas en la web.
        </h4>
        <h4>
            Comunicación de los datos: no se comunicarán los datos a terceros, excepto en 
            cookies propiedad de terceros o por obligación legal.
        </h4>
        ...
        <h4>
            Desde este panel podrá configurar las cookies que el sitio web puede instalar en su 
            navegador, excepto las cookies técnicas o funcionales que son necesarias para la 
            navegación y la utilización de las diferentes opciones o servicios que se ofrecen. <br><br>

            Las cookies seleccionadas indican que el usuario autoriza la instalación en su navegador y el 
            tratamiento de datos bajo las condiciones reflejadas en la Política de cookies.<br><br>

            El usuario puede marcar o desmarcar el selector según se desee aceptar o rechazar la 
    ...
    <footer> 
        <a href="https://www.turomas.com/">https://www.turomas.com/</a>
        <a href="https://www.youtube.com/watch?v=-oK6zL01fNM"> CSS </a>
    </footer>
